...
public class Sistema
{
    ...
    private void PreCarga()
    {
       ...
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Revisar el sistema de riego", new DateTime(2024, 5, 17), false, new DateTime(2024, 5, 18), "Prepararse para la temporada seca"));
       ...
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Realizar vacunación contra enfermedades respiratorias en bovinos", new DateTime(2024, 5, 13), true, new DateTime(2024, 5, 14), "Prioridad alta"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Controlar y tratar garrapatas en ovejas", new DateTime(2024, 5, 14), true, new DateTime(2024, 5, 15), "Necesario con urgencia"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Supervisar y asistir en parto de ovejas preñadas", new DateTime(2024, 5, 15), true, new DateTime(2024, 5, 16), "Inmediatamente"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Alimentar a los terneros con suplementos nutritivos", new DateTime(2024, 5, 16), true, new DateTime(2024, 5, 17), "Mantener crecimiento"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Controlar la calidad del forraje para ovinos", new DateTime(2024, 5, 17), false, new DateTime(2024, 5, 18), "Optimizar nutrición"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Monitorear signos de enfermedad en el ganado", new DateTime(2024, 5, 18), false, new DateTime(2024, 5, 19), "Prevenir brotes"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Entrenamiento y socialización de corderos", new DateTime(2024, 5, 19), false, new DateTime(2024, 5, 20), "Mejorar comportamiento"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Realizar tratamiento preventivo para mastitis en vacas lecheras", new DateTime(2024, 5, 20), false, new DateTime(2024, 5, 21), "Evitar infecciones"));
        ((Peon)_empleados[12]).AgregarTarea(new Tarea("Supervisar el destete de corderos", new DateTime(2024, 5, 21), false, new DateTime(2024, 5, 22), "Minimizar estrés"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Control de calidad de la leche en vacas lecheras", new DateTime(2024, 5, 22), false, new DateTime(2024, 5, 23), "Mantener estándares"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Revisar y limpiar las instalaciones de ordeño", new DateTime(2024, 5, 23), true, new DateTime(2024, 5, 24), "Mantener higiene"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Cuidado de ubres en vacas lecheras", new DateTime(2024, 5, 24), true, new DateTime(2024, 5, 25), "Prevenir mastitis"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Entrenamiento de bueyes para trabajos agrícolas", new DateTime(2024, 5, 25), true, new DateTime(2024, 5, 26), "Mejorar habilidades"));
       ((Peon)_empleados[12]).AgregarTarea(new Tarea("Monitorear el crecimiento de terneros", new DateTime(2024, 5, 26), true, new DateTime(2024, 5, 27), "Detectar problemas nutricionales"));
