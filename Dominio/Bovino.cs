...
{
	internal class Bovino : Animal, IValidable , IGanancia
	{
		...
		public Bovino(TipoAlimentacion tipoAliemntacion, double pesoKilo, TipoAnimal genero, string raza, DateTime fechaNacimiento, double costoAdquisicion,
